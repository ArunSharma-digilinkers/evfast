...
<div class="main-wrapper py-4">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('admin.shipping-zones.index') }}" class="btn btn-secondary shadow-sm">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.shipping-zones.update', $shipping_zone->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select" required>
                                <option value="1" {{ old('status', $shipping_zone->status) ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ !old('status', $shipping_zone->status) ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
