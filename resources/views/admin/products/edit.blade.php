                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.products.update', $product->id) }}"
                            ...
                            <div class="form-check">
                                <input type="checkbox" name="addons[]" value="{{ $addon->id }}" class="form-check-input"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3 mb-2">
                                        <img src="{{ asset('storage/products/gallery/'.$img) }}" class="img-thumbnail">
                                    </div>
                                    @endforeach
                                </div>
                                @endif
                             ...
                             <div class="mb-3">
                                ...
                                <input type="url" name="youtube_url" class="form-control"
                                    placeholder="https://www.youtube.com/embed/VIDEO_ID" value="{{ old('youtube_url', $product->youtube_url) }}">
